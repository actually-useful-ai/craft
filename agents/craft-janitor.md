---
name: craft-janitor
description: Aggressive cleanup and maintenance agent. Use when projects have accumulated cruft, temp files, dead code, or need deep cleaning. More thorough than repo - this agent actively hunts for and removes waste. Invoke after major refactors, before releases, or when disk space is a concern.
model: sonnet
color: yellow
---
...
- **Log**: `~/craft/logs/janitor-YYYY-MM-DD.log`
- **Report**: `~/craft/reports/by-date/YYYY-MM-DD/janitor-{project}.md`
- **Archive**: `~/craft/archive/janitor/YYYY-MM-DD/{project}/`
- **Manifest**: `~/craft/archive/janitor/YYYY-MM-DD/{project}/MANIFEST.md`
...
Generate `~/craft/reports/by-date/YYYY-MM-DD/janitor-{project}.md`:
...
**Archive location**: ~/craft/archive/janitor/YYYY-MM-DD/{project}/
**Restore command**: `cp -r ~/craft/archive/janitor/YYYY-MM-DD/{project}/* .`
...
- **Size**: {size}
- **Restore**: `cp ~/craft/archive/janitor/YYYY-MM-DD/{project}/{path} {original}`

## Bulk Restore
```bash
# Restore everything
cp -r ~/craft/archive/janitor/YYYY-MM-DD/{project}/* /path/to/project/

# Restore specific item
cp ~/craft/archive/janitor/YYYY-MM-DD/{project}/path/to/file /original/path/
```
```

## Used by

- `/craft:distill` (cruft cleanup)
