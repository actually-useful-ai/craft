...
- **Reports**: `~/craft/reports/by-date/YYYY-MM-DD/validation-{project}.md`
- **HTML**: `~/docs/craft/validation-{project}.html`
...
- Proxy configuration matches service ports
...
Cross-domain checks:
- **Service Manager <-> Proxy**: Ports match
...
Create `~/craft/reports/by-date/YYYY-MM-DD/validation-{project}.md`:
...
| Paths | pass/warn/fail | {count} |
| Permissions | pass/warn/fail | {count} |
...
|------|--------|----------|----------|-------|
| /path/to/app.py | Yes | Yes | - | OK |
| /path/to/logs/ | Yes | Yes | No | Need write permission |
...
- `/craft:reconsider` (L2 validation)
