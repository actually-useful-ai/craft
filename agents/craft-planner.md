...
- **Task Queue**: `~/craft/hive/{project}-queue.md`
- **Reports**: `~/craft/reports/by-date/YYYY-MM-DD/planner-{project}.md`
...
### Priority 4: Existing Reports
```
~/craft/recommendations/by-project/{project}.md
CRITIC.md
*-report.md
```
...
Generate `~/craft/hive/{project}-queue.md`:
