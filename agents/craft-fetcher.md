...
- **Fetched Content**: `~/craft/swarm/cache/{hash}.md`
- **Reports**: `~/craft/reports/by-date/YYYY-MM-DD/fetch-log.md`
...
Path = ~/craft/swarm/cache/{hash}.md
```
...
- `/craft:discuss` (research/documentation)
